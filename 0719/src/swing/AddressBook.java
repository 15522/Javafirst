...
public class AddressBook extends JFrame {
	...
	String [][] data = {
				...
				{"박문석","01037901997","서울시 양천구 목동"}, {"제시카", "12341234123","뉴질랜드"},{"헌트","12341234123","영국 런던"},{"브라이언","12341234123","뉴질랜드크"}
};
		...
		*/
		...
		ActionListener insertListener = new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				//테이블의 데이터를 편집하기 위해서 테이블의 데이터 모델을 가져옵니다.
		...
		ActionListener deleteListener = new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				//테이블에서 행을 선택하지 않았다면
				//if(idx <0 || idx >=table.getTowCount())
