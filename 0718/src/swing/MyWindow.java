...
public class MyWindow extends JFrame {
	...
	public MyWindow() {
		...
		ImageIcon icon = new ImageIcon("C:\\Users\\503-22\\Documents\\김태완\\박문석선생님\\0.png");
		...
		Thread th = new Thread() {
			public void run() {
				...
				while (true) {
					try {
						Thread.sleep(100);
						ImageIcon icon = new ImageIcon("C:\\Users\\503-22\\Documents\\김태완\\박문석선생님\\" + images[idx%images.length]);
						//list.get(idx%list.size())); 리스트
								label.setIcon(icon);
						idx = idx + 1;
